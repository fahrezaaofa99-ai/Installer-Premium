...
show_banner() {
    clear
    echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║${WHITE}              PTERODACTYL PROTECT INSTALLER                ${BLUE}║${NC}"
...
class ServerController extends Controller
{
    ...
    public function view(Server $server): View
    {
        ...
        if ($user->id !== 1 && $server->owner_id !== $user->id) {
            abort(403, '🚫 Akses ditolak: Hanya admin ID 1 yang dapat melihat atau mengedit server ini! ©Protect By @padukarezz.');
        }
    ...
    public function update(Request $request, Server $server)
    {
        ...
        if ($user->id !== 1 && $server->owner_id !== $user->id) {
            abort(403, '🚫 Akses ditolak: Hanya admin ID 1 yang dapat mengubah server ini! ©Protect By @padukarezz.');
        }
    ...
    public function destroy(Server $server)
    {
        ...
        if ($user->id !== 1) {
            abort(403, '🚫 Akses ditolak: Hanya admin ID 1 yang dapat menghapus server ini! ©Protect By @padukarezz.');
        }
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException(
                    '🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mengubah detail server milik orang lain! ©Protect By @padukarezz'
                );
            }
        }
...
class BuildModificationService
{
    ...
    public function handle(Server $server, array $data): Server
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException(
                    '🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mengubah Build Configuration server orang lain! ©Protect By @padukarezz'
                );
            }
        }
...
class StartupModificationService
{
    ...
    public function handle(Server $server, array $data): Server
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException(
                    '🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mengubah startup command server orang lain! ©Protect By @padukarezz'
                );
            }
        }
...
class DatabaseManagementService
{
    ...
    public function create(Server $server, array $data): Database
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat membuat database untuk server orang lain! ©Protect By @padukarezz');
            }
        }
    ...
    public function delete(Database $database): ?bool
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($server && $server->owner_id !== $user->id) {
                throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat menghapus database server orang lain! ©Protect By @padukarezz');
            }
        }
...
class ServerTransferController extends Controller
{
    ...
    public function transfer(Request $request, Server $server): RedirectResponse
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mentransfer server orang lain! ©Protect By @padukarezz');
            }
        }
...
class ServersController extends Controller
{
    ...
    public function toggleInstall(Server $server): RedirectResponse
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mengubah status instalasi server orang lain! ©Protect By @padukarezz');
            }
        }
    ...
    public function manageSuspension(Request $request, Server $server): RedirectResponse
    {
        ...
        if ($user && $user->id !== 1) {
            ...
            if ($ownerId !== $user->id) {
                throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mensuspend server orang lain! ©Protect By @padukarezz');
            }
        }
    ...
    public function handle(Server $server): Server
    {
        ...
        if ($user) {
            if ($user->id !== 1) {
                ...
                if ($ownerId !== $user->id) {
                    throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat me-reinstall server orang lain! ©Protect By @padukarezz');
                }
            }
        }
    ...
    public function handle(Server $server): void
    {
        ...
        if ($user) {
            if ($user->id !== 1) {
                ...
                if ($ownerId !== $user->id) {
                    throw new DisplayException('🚫 Akses ditolak: Hanya Admin ID 1 yang dapat menghapus server orang lain! ©Protect By @padukarezz');
                }
            }
        }
...
class UserController extends Controller
{
    ...
    public function delete(Request $request, User $user): RedirectResponse
    {
        ...
        if ($authUser->id !== 1) {
            throw new DisplayException("🚫 Akses ditolak: hanya admin ID 1 yang dapat menghapus user! ©Protect By @padukarezz");
        }
    ...
    public function store(NewUserFormRequest $request): RedirectResponse
    {
        ...
        if ($authUser->id !== 1 && isset($data['root_admin']) && $data['root_admin'] == true) {
            throw new DisplayException("🚫 Akses ditolak: Hanya admin ID 1 yang dapat membuat user admin! ©Protect By @padukarezz.");
        }
    ...
    public function update(UserFormRequest $request, User $user): RedirectResponse
    {
        ...
        foreach ($restrictedFields as $field) {
            if ($request->filled($field) && $request->user()->id !== 1) {
                throw new DisplayException("⚠️ Data hanya bisa diubah oleh admin ID 1. ©Protect By @padukarezz");
            }
        }

        if ($user->root_admin && $request->user()->id !== 1) {
            throw new DisplayException("🚫 Akses ditolak: Hanya admin ID 1 yang dapat menurunkan hak admin user ini! ©Protect By @padukarezz.");
        }

        if ($request->user()->id !== 1 && $request->user()->id !== $user->id) {
            throw new DisplayException("🚫 Akses ditolak: Hanya admin ID 1 yang dapat mengubah data user lain! ©Protect By @padukarezz.");
        }
    ...
    public function json(Request $request): Model|Collection
    {
        ...
        if ($request->query('user_id')) {
            ...
            if ($authUser->id !== 1 && $authUser->id !== $user->id) {
                throw new DisplayException("🚫 Akses ditolak: Hanya admin ID 1 yang dapat melihat data user lain! ©Protect By @padukarezz.");
            }
...
class LocationController extends Controller
{
    ...
    public function index(): View
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: Hanya admin utama (ID 1) yang dapat mengakses menu Location! ©Protect By @padukarezz.');
        }
...
class NodeController extends Controller
{
    ...
    private function checkAdminAccess(): void
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak! Hanya Admin utama (ID 1) yang dapat mengakses menu Nodes. ©Protect By @padukarezz');
        }
    }
...
class NestController extends Controller
{
    ...
    private function checkAdminAccess(): void
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak! Hanya Admin utama (ID 1) yang dapat membuka menu Nests. ©Protect By @padukarezz');
        }
    }
...
class IndexController extends Controller
{
    ...
    public function index(): View
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: Hanya admin ID 1 yang dapat membuka menu Settings! ©Protect By @padukarezz.');
        }
    ...
    public function update(BaseSettingsFormRequest $request): RedirectResponse
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: Hanya admin ID 1 yang dapat update menu Settings! ©Protect By @padukarezz.');
        }
...
class FileController extends ClientApiController
{
    ...
    private function checkServerAccess($request, Server $server)
    {
        ...
        if (!$authUser) {
            abort(403, '🚫 Tidak dapat memverifikasi pengguna. Silakan login ulang. ©PadukaProtect');
        }
        ...
        if ($authUser->id !== $server->owner_id) {
            abort(403, "🚫 Kasihan gabisa yaaa? 😹 Ini bukan servermu! Akses ditolak total. ©Protect By @padukarezz");
        }
    }
...
class ServerController extends ClientApiController
{
    ...
    public function index(GetServerRequest $request, Server $server): array
    {
        ...
        if ($authUser->id !== 1 && (int) $server->owner_id !== (int) $authUser->id) {
            abort(403, '🚫 Kasihan gabisa yaaa? 😹 Hanya Admin utama (ID 1) atau pemilik server yang dapat melihat server ini! ©Protect By @padukarezz');
        }
...
class ApiController extends Controller
{
    ...
    private function protectAccess()
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Kasihan gabisa yaaa? 😹 Hanya Admin utama (ID 1) yang dapat mengakses halaman APIKEY! ©Protect By @padukarezz');
        }
    }
...
class ApiKeyController extends ClientApiController
{
    ...
    {
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: Hanya Admin ID 1 yang dapat mengelola API Key! ©Protect By @padukarezz.');
        }
    }
...
class DatabaseController extends Controller
{
    ...
    private function checkAccess()
    {
        ...
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: hanya admin ID 1 yang dapat mengelola Database! ©Protect By @padukarezz');
        }
    }
...
class MountController extends Controller
{
    ...
    private function checkAdminAccess()
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: hanya Admin utama (ID 1) yang boleh akses Mount! ©Protect By @padukarezz');
        }
    }
...
class TwoFactorController extends ClientApiController
{
    ...
    {
        if ($request->user()->id !== 1) {
            abort(403, '🚫 Kasihan gabisa yaaa? 😹 Hanya Admin utama (ID 1) yang dapat mengatur Two-Step Verification. ©Protect By @padukarezz');
        }
    ...
    {
        if ($request->user()->id !== 1) {
            abort(403, '🚫 Kasihan gabisa yaaa? 😹 Hanya Admin utama (ID 1) yang dapat mengaktifkan Two-Step Verification. ©Protect By @padukarezz');
        }
    ...
    {
        if ($request->user()->id !== 1) {
            abort(403, '🚫 Kasihan gabisa yaaa? 😹 Hanya Admin utama (ID 1) yang dapat menonaktifkan Two-Step Verification. ©Protect By @padukarezz');
        }
...
main() {
    ...
    echo ""
    echo -e "${GREEN}╔════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${GREEN}║${WHITE}              INSTALASI SELESAI!                           ${GREEN}║${NC}"
    echo -e "${GREEN}║${WHITE}                                                           ${GREEN}║${NC}"
    echo -e "${GREEN}║${WHITE}  Semua protect (1-14) telah diinstall!                   ${GREEN}║${NC}"
    echo -e "${GREEN}║${WHITE}  Panel Pterodactyl Anda sekarang lebih aman.            ${GREEN}║${NC}"
    echo -e "${GREEN}║${WHITE}                                                           ${GREEN}║${NC}"
    echo -e "${GREEN}║${WHITE}  Created by: @padukarezz                                 ${GREEN}║${NC}"
    echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
}
